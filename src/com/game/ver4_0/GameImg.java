...
class GameImg {
	...
	private Image aimShotgunLeftImg; // 瞄准状态霰弹向左图片
	private Image aimShotgunRightImg; // 瞄准状态霰弹向右图片
	
	private Image[] dieLeftImg; // 死亡向左图片
	private Image[] dieRightImg; // 死亡向右图片
	
	private Image squatLeftImg; // 下蹲向左图片
	private Image squatRightImg; // 下蹲向右图片
	...
	private Image epAimShotgunLeftImg; // 瞄准状态霰弹向左图片
	private Image epAimShotgunRightImg; // 瞄准状态霰弹向右图片
	


	private Image[] epDieLeftImg; // 死亡向左图片
	private Image[] epDieRightImg; // 死亡向右图片
	
	private Image[] epTypeImg;//敌人种类标志图片
	
	private Image[] tipImg;//游戏提示需要的图片
	

	// 以下是武器图片
	private Image weaponHandgunImg; // 手枪武器图片
	private Image weaponShotgunImg; // 霰弹武器图片
	...
	public GameImg() {
		...
		dieLeftImg = new Image[11];
		dieRightImg = new Image[11];
		...
		epDieLeftImg = new Image[11];
		epDieRightImg = new Image[11];
		
		epTypeImg = new Image[4];
	...
	public void loadMpImg() {
		...
		// 加载瞄准状态右手臂图片
		aimHandRightImg = this.loadImg("/image/aim/hand/right/0.png");
		...
		// 加载瞄准状态霰弹向左图片
		aimShotgunLeftImg = this.loadImg("/image/aim/shotgun/left/0.png");
		
		// 加载瞄准状态霰弹向右图片
		aimShotgunRightImg = this.loadImg("/image/aim/shotgun/right/0.png");
		...
		// 加载死亡向左图片
		this.loadImg("/image/die/left/", dieLeftImg);
		
		// 加载死亡向右图片
		this.loadImg("/image/die/right/", dieRightImg);
		
		// 加载下蹲向左图片
		squatLeftImg = this.loadImg("/image/squat/left/0.png");
		
		// 加载下蹲向右图片
		squatRightImg = this.loadImg("/image/squat/right/0.png");
...
//		epAimHandLeftImg = this.loadImg("/image/epImg/aim/hand/right/0.png");
		...
		// 加载瞄准状态霰弹向左图片
		epAimShotgunLeftImg = this.loadImg("/image/epImg/aim/shotgun/left/0.png");
				
		// 加载瞄准状态霰弹向右图片
		epAimShotgunRightImg = this.loadImg("/image/epImg/aim/shotgun/right/0.png");
		...
		// 加载死亡向左图片
		this.loadImg("/image/epImg/die/left/", epDieLeftImg);
				
		// 加载死亡向右图片
		this.loadImg("/image/epImg/die/right/", epDieRightImg);
		
		//加载敌人标志图片
		this.loadImg("/image/type/",epTypeImg);
	}

	// 加载武器图片方法
	public void loadWeaponImg() {
		// 加载手枪
		this.weaponHandgunImg = this.loadImg("/image/weapon/handgun/0.png");
		
		// 加载霰弹
		this.weaponShotgunImg = this.loadImg("/image/weapon/shotgun/0.png");
	}
	
	
	public Image[] getEpDieLeftImg() {
		return epDieLeftImg;
	}

	public Image[] getEpDieRightImg() {
		return epDieRightImg;
	}
	
	
	public Image[] getDieLeftImg() {
		return dieLeftImg;
	}

	public Image[] getDieRightImg() {
		return dieRightImg;
	}
	...
	public Image getSquatLeftImg() {
		return squatLeftImg;
	}

	public Image getSquatRightImg() {
		return squatRightImg;
	}

	public Image getWeaponHandgunImg() {
		return weaponHandgunImg;
	}
	
	public Image[] getEpTypeImg() {
		return epTypeImg;
	}
	...
	public Image getAimShotgunLeftImg() {
		return aimShotgunLeftImg;
	}

	public Image getAimShotgunRightImg() {
		return aimShotgunRightImg;
	}

	public Image getWeaponShotgunImg() {
		return weaponShotgunImg;
	}
	
	public Image getEpAimShotgunLeftImg() {
		return epAimShotgunLeftImg;
	}

	public Image getEpAimShotgunRightImg() {
		return epAimShotgunRightImg;
	}
}
